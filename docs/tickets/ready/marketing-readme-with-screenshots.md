...
Replace the README with marketing-oriented documentation that positions Sapphire and shows it off.

Positioning and content:

- **Pitch** — a lightweight markdown editor; a slimmed-down Obsidian. Fast, focused, no bloat.
- **Open any folder** — emphasise that Sapphire runs against *any* folder of markdown files. There is no proprietary "vault" concept to opt into; point it at an existing directory and edit.
...
The app icon (sapphire gem) can be used as a logo/hero at the top.

## Acceptance criteria

- [ ] README markets Sapphire as a lightweight, slimmed-down-Obsidian markdown editor
...
- [ ] README uses the Sapphire name throughout (no "emerald")

## Blocked by

- docs/tickets/ready/rename-app-to-sapphire.md
- docs/tickets/ready/retheme-to-sapphire-palette.md
